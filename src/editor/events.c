...
static void		ft_editor_left_rotation(t_wolf3d *w)
{
...
static void		ft_editor_right_rotation(t_wolf3d *w)
{
	t_matrix_4x4	rotation_matrix;
...
static void		ft_editor_top_rotation(t_wolf3d *w)
{
	w->pl.cameraH += 0.02;
...
static void		ft_editor_bottom_rotation(t_wolf3d *w)
{
	w->pl.cameraH -= 0.02;
	if (w->pl.cameraH < 1.0)
		w->pl.cameraH = 1;
...
static void		ft_editor_top_camera_rotation(t_wolf3d *w)
{
	double			camera_tilt;
	t_matrix_4x4	rotation_matrix;
...
static void		ft_editor_bottom_camera_rotation(t_wolf3d *w)
{
	double			camera_tilt;
	t_matrix_4x4	rotation_matrix;
...
void			ft_editor_use_events(t_wolf3d *w)
{
	...
	w->arr[2] == 1 ? ft_editor_left_rotation(w) : 0;
	w->arr[3] == 1 ? ft_editor_right_rotation(w) : 0;
