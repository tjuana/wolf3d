...
/*   Updated: 2019/11/29 17:44:55 by dorange-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_load_textures(t_wolf3d *w)
{
	...
	w->sdl->surfaces[9] = ft_sdl_load_bmp("Textures/WALL66.bmp");
	...
	w->sdl->surfaces[16] = ft_sdl_load_bmp("Textures/WALL98.bmp");
	w->sdl->surfaces[17] = ft_sdl_load_bmp("Textures/Wood1.bmp");
	w->sdl->surfaces[18] = ft_sdl_load_bmp("Textures/WALL90.bmp");
	w->sdl->surfaces[19] = ft_sdl_load_bmp("Textures/WALL8.bmp");
