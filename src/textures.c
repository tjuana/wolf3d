...
/*   Updated: 2019/12/09 21:11:49 by drafe            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_load_textures(t_wolf3d *w)
{
	...
	w->sdl->surfaces[0] = ft_sdl_load_bmp("Textures/purplestone.bmp");
	...
	w->sdl->surfaces[17] = ft_sdl_load_bmp("Textures/Wood1.bmp");//door
