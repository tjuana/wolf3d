...
/*   Updated: 2019/11/25 17:03:28 by drafe            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_load_textures(t_wolf3d *w)
{
	...
	w->sdl->surfaces[2] = ft_sdl_load_bmp("Textures/Stone9.bmp");
	w->sdl->surfaces[3] = ft_sdl_load_bmp("Textures/WALL24.bmp");
	...
	w->sdl->surfaces[16] = ft_sdl_load_bmp("Textures/Wood1.bmp");
	w->sdl->surfaces[17] = ft_sdl_load_bmp("Textures/Wood100.bmp");
	w->sdl->surfaces[18] = ft_sdl_load_bmp("Textures/WALL90.bmp");
	w->sdl->surfaces[19] = ft_sdl_load_bmp("Textures/WALL68.bmp");
