...
/*   Updated: 2019/12/04 21:34:16 by drafe            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		renderer(t_wolf3d *w)
{
	...
	w->pl.st.f_sz = 56;
	ft_putstr_sdl(w, "life:", w->pl.st.f_sz * 5, WIN_HEIGHT - 66);
	ft_putstr_sdl(w, ft_itoa(w->pl.st.life), w->pl.st.f_sz * 7, WIN_HEIGHT - 66);
	ft_putstr_sdl(w, "ammo:", w->pl.st.f_sz * 9, WIN_HEIGHT - 66);
	ft_putstr_sdl(w, ft_itoa(w->pl.st.ammo), w->pl.st.f_sz * 12, WIN_HEIGHT - 66);
