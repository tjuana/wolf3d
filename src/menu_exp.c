...
/*   Updated: 2020/01/03 20:46:51 by drafe            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	SDL_Rect	tmp_rect;
	...
	//SDL_SetTextureBlendMode(tmp_texture, SDL_BLENDMODE_ADD) != 0 ? ft_sdl_error(w) : 0;
	//SDL_SetTextureBlendMode(tmp_texture, SDL_BLENDMODE_BLEND) != 0 ? ft_sdl_error(w) : 0;
	//SDL_SetTextureBlendMode(tmp_texture, SDL_BLENDMODE_MOD) != 0 ? ft_sdl_error(w) : 0;
	//SDL_SetTextureBlendMode(tmp_texture, SDL_BLENDMODE_NONE) != 0 ? ft_sdl_error(w) : 0;